...
grahSet<-grahSet[2:113,]
dim(predx)
k=1
dataset<-data.frame(y=y[2:113,k],grahSet,x=predx[2:113,k])
suppressWarnings( library(ROCR))
d = dataset
...
names <- c("LR","KNN1","KNN3","KNN5","NB","dtree","dtreeP17","dtreeP3","SVMRA","SVMPOLY","SVMSIG")
barplot(globalauc,names.arg = names)
